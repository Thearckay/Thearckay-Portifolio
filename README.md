...
* **React Router:** Implementação de navegação SPA (Single Page Application) para transições fluidas entre seções e gerenciamento de rotas.
...
O portfólio é dividido em seções que refletem minha trajetória em Análise e Desenvolvimento de Sistemas:

* **Projetos Acadêmicos:** Aplicação de lógica de programação e engenharia de software com foco em Java e MySQL.
* **Projetos Pessoais:** Exploração de tecnologias Full Stack (Spring Boot e React) e desenvolvimento mobile com Kotlin.

## Autor

**Kayck Arcanjo** Graduando em Análise e Desenvolvimento de Sistemas – UNIASSELVI.  
[LinkedIn](https://www.linkedin.com/in/kayck-arcanjo/) | [GitHub](https://github.com/Thearckay)